...
import { useRegister, registerInputSchema } from '@/libs/auth';
...
export const RegisterForm = ({
  ...
  const registering = useRegister({ mutationConfig: { onSuccess } });
          ...
          <>
            ...
            <div className="flex items-center space-x-2">
              <Switch
                ...
                id="choose-team"
              />
              <Label htmlFor="choose-mode">Join Existing Team</Label>
            </div>
