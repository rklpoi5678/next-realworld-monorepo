  ...
  return (
    <div className="flex flex-col md:flex-row gap-0 items-stretch justify-center overflow-hidden bg-white rounded-3xl shadow-2xl border border-gray-200">
      ...
      <div className="flex-1 p-10 flex flex-col justify-center bg-white">
        ...
        <div className={`mt-4 p-5 rounded-2xl transition-all duration-500 ${selected ? 'bg-blue-50 border-2 border-blue-500/20' : 'bg-slate-50 border-2 border-dashed border-slate-200'}`}>
          <div className="flex items-center gap-3">
            <div className={`w-3 h-3 rounded-full ${selected ? 'bg-blue-500 animate-pulse' : 'bg-slate-300'}`} />
